const identity = { name: "Rahul Ponnumariappan", image: "Profile-pic" };
const data = {
	NavBar: {
		...identity,
		links: [
	...
	Home: {
		introduction:
			"I am a 2024 passed out student of Bachelor of Engineering in Computer Science Engineering from Hindusthan College of Engineering and Technology",
	...
	About: {
		...
		about: {
			"tech-stats": "Data Science And Analytics Enthusiast",
			bio: "An Enthusiast Coder Eager to contribute to team success through hard work, skills, attention to details and excellent organizational skills. Currently, Exploring the world of Technology as an Data Science Enthusiast. Formerly worked as a Data Science Intern at KGISL for 6 months and Software Developer intern at Softyuga for 1 month.",
			"IDE, Editors & Tools": [
				"Android Studio",
				"Intellij",
				"PyCharm",
		...
		skills: [
			[
				...
				{ skill: "My-SQL", progress: "85" },
				{ skill: "Excel", progress: "90" },
				{ skill: "TABULEA", progress: "80" },
			...
			[
				...
				{ skill: "POWER-BI", progress: "90" },
				{ skill: "GEN-AI", progress: "20" },
			],
		],
		education: [
			{
				...
				textAlignment: "right",
				degree: "Bachelor of Engineering (B.E), Computer Science And Technology",
			...
			},
			{
				...
				college: "Sri Ramana Vidhyalaya Matric Higher Secondary School",
				duration: "Year of Completion : 2020",
				percentage: "Percentage : 67.14%",
			},
			{
				animationClass: "Right left",
				textAlignment: "right",
	...
	Contact: [
		...
		},
		{
			...
			links: [{ type: "mailto:", title: "jgoel92@gmail.com" }],
		},
	],
	Social: [
		[
